...
readline.question('', N => {
    readline.question('', days => {
        let evenDays = [];
        let oddDays = [];
        days.split(" ").forEach(day => day % 2 === 0 ? evenDays.push(day) : oddDays.push(day));
        console.log(oddDays.join(" "));
        console.log(evenDays.join(" "));
        console.log(evenDays.length >= oddDays.length ? "YES" : "NO");
    });
});